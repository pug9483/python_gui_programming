...
from tkinter import filedialog  # 별도로 명시해야됨
...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요", \
                                        ...
                                        initialdir=r"C:\Users\pugpu\PycharmProjects\Arcade_game\pygame_project\images")  # 최초에 C:/경로를 보여줌
    # 사용자가 선택한 파일 목록
    for file in files:
...
# 3. 파일 포맷 옵션
# 파일 포맷 옵션 레이블
lol_format = Label(frame_option, text="포맷", width=8)
lol_format.pack(side="left", padx=5, pady=5)
